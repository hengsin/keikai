...
public class EngineFactory {
	...
	static {
		String clz = Library.getProperty("io.keikai.model.InputEngine.class");
		if(clz!=null){
			try {
	...
	static {
		String clz = Library.getProperty("io.keikai.model.FormulaEngine.class");
		if(clz!=null){
			try {
	...
	static {
		String clz = Library.getProperty("io.keikai.model.DependencyTable.class");
		if(clz!=null){
			try {
	...
	static {
		String clz = Library.getProperty("io.keikai.model.FormatEngine.class");
		if(clz!=null){
			try {
